...
{
    public partial class TCĐH : Form
    {
        string nameimg;
        ...
        private void dgvsp_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                else
                {
                    ...
                    if (File.Exists(@"D:\vothikimmen\img\" + img))
                    {
                        // Hiển thị hình ảnh trong PictureBox
                        pictureBox.Image = new Bitmap(@"D:\vothikimmen\img\" + img);
        ...
        private void btNew_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Số lượng sản phẩm phải là số!", "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
        ...
        private void btEdit_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Sản Phẩm đã được cập nhật!", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void btFile_Click(object sender, EventArgs e)
        {
            ...
            if (openFileDialog.ShowDialog() == DialogResult.OK)
            {
                ...
                string targetDirectory = @"D:\vothikimmen\img\";

...
namespace QLBH_VoThiKimMen.GUII
{
    public partial class FormHoaDon : Form
    {
        ...
        private void cbMSP_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                str = "Select price from sanpham where id = N'" + cbMSP.SelectedValue + "'";
                txtGia.Text = dbConnection.GetFieldValues(str);

                str = "Select quantity_in_stock from sanpham where id = N'" + cbMSP.SelectedValue + "'";
                txtSL.Text = dbConnection.GetFieldValues(str);
                str = "Select name from sanpham where id = N'" + cbMSP.SelectedValue + "'";
        ...
        private SqlConnection CreateConnection()
        {
            ...
            string connectionString = @"Data Source= LAPTOP-KVJUQTAP\SQLEXPRESS ;Initial Catalog= TaiKhoan; User Id=sa; Password=sa";
